(function () {
  ...
  if (!scriptSeleccionado) {
    ...
    bg.style.backgroundImage = "url('https://i.imgur.com/7D33D1u.jpeg')"; // Ä°stediÄŸin gÃ¶rsel buraya
    ...
    function crearMenu() {
      ...
      container.innerHTML = `
        ...
        <div id="buttons">
          <button id="opcion1" class="menu-button" aria-label="Worm oyununu baÅŸlat">â–¶ï¸ WKQ 1 V1</button>
	  <button id="opcion2" class="menu-button" aria-label="Worm oyununu baÅŸlat">â–¶ï¸ WKQ V2 (Preimum New)</button>
      `;
